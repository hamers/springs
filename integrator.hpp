...
class Integrator
{
    public:
        ...
        virtual ~Integrator() {};
        void compute_node_vel_acc_at_given_pos_vel(const std::vector<Node *> &nodes, const Node node, Vector pos, Vector vel, Vector &vel_out, Vector &acc_out, const Parameters &parameters);
};
